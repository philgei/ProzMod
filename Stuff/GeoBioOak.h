...
// CGeoBioOak 
// 
// Erklärung: Klasse, um prozedural realistische Eichen-Geometrien zu erzeugen
...
namespace Vektoria
{
	class CGeoBioOak : public CGeoBio
	{
	public:
		...
		/// Achtung Nr. 1! Nach "Itarate" müssen eine oder mehere "Init"-Methoden verschiedener Objektinstanzen aufgerufen werden, um die Geometrie zu erzeugen.<para></para>
		...
		///<param name="fAge"> Alter der Eiche in Jahren (Je älter, desto größer und komplexer). </param>
		...
		/// 3 => etc.</param>
		void Init(CGeoBioOak * pzgTemplate, unsigned int uLoD = 0);
