...
// CGeoBioOak 
// 
// Erklärung: Klasse, um prozedural realistische Eichen-Placements 
...
#define PLANTOAK_LODS 7


namespace Vektoria
{
	class CPlantOak : public CPlacement
	{
	public:
		...
		CPlacement m_azpLoD[PLANTOAK_LODS];

		///<summary> Array mit den LoD-Untergeometrien </summary> 
		CGeoBioOak m_azgLoD[PLANTOAK_LODS];
