...
CGeoBioChelidoniumMajus::CGeoBioChelidoniumMajus()
{
}
...
void CGeoBioChelidoniumMajus::Iterate(float fAge, float frTimeOfYear, float fRootCutHeight)
{
	m_fAge = fAge;
...
void CGeoBioChelidoniumMajus::DeIterate()
{
...
void CGeoBioChelidoniumMajus::Init(CGeoBioChelidoniumMajus * pzgTemplate,  unsigned int uLoD)
{
	if(!pzgTemplate)
	{
		return;
...
float CGeoBioChelidoniumMajus::GetOptimalLoDMin(float fAge, unsigned int uLoD)
{
...
float CGeoBioChelidoniumMajus::GetOptimalLoDMax(float fAge, unsigned int uLoD)
{
	float m_fAgeStopped = fAge;
	if (m_fAgeStopped > 1.0f)
		m_fAgeStopped = 1.0f;
